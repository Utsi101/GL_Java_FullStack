package com.greatlearning.dsa.gradedproject2.question2;
...
public class ConvertBinaryIntoSkewedTree {
	Node node;
	Node prev = null;
	Node newHead = null;
...
//traverse till leaf
	...
	public static void main(String[] args) {
		// given code to test
		ConvertBinaryIntoSkewedTree tree = new ConvertBinaryIntoSkewedTree();
